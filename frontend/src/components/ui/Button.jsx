...
const Button = ({
  ...
  const variants = {
    primary: 'bg-primary hover:bg-primary-dark text-[#423C35] font-bold focus:ring-primary shadow-soft',
    secondary: 'bg-secondary hover:bg-secondary-dark text-[#423C35] font-bold focus:ring-secondary shadow-soft',
